...
#include <systemc.h>
#include "mac_2_conf_info.hpp"
#include "mac_2_specs.hpp"
#include "mac_2_data_types.hpp"
...
SC_MODULE(testbench)
{
    ...
    uint32_t kalman_mat_dim; // Number of num_iterations (4: [X_GPS(i); X_pos(i); Y_GPS(i); Y_pos(i)])
